...
//        // 取屏幕高
//        val outerHeight = resources.displayMetrics.heightPixels - (25 * resources.displayMetrics.density).toInt() //得减去标题栏高度
//        //取屏幕宽
//        val outerwidth = resources.displayMetrics.widthPixels
//        val layoutlp: ViewGroup.LayoutParams = mainView.getLayoutParams()
//        layoutlp.width = outerwidth / 3*2
//        layoutlp.height = outerHeight / 3*2
//        mainView.setLayoutParams(layoutlp)
